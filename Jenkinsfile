node {
    ...
    try {
        ...
        slackSend channel: '#nais-internal', color: "good", message: ":nais: ${clusterName} successfully nsynced. ${env.BUILD_URL}", teamDomain: 'nav-it', tokenCredentialId: 'slack_fasit_frontend'
